...
# Old namespace stamp (minecraft:heart_container)
...
execute if score #crystal_heart_migrate version_number matches 1 run return run loot give @s loot matcha:treasure/crystal_heart

# Pre-rework matcha hearts (explicitly non-consumable) → new usable format
