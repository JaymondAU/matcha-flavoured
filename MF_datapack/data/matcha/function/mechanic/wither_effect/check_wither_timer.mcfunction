...
execute if score @s wither_timer matches 8.. run function matcha:mechanic/heart_container/hpdown
...
execute if predicate matcha:effects/has_wither run schedule function matcha:mechanic/wither_effect/check_wither_timer 1s